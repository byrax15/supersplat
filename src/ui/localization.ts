...
import getDefaults from 'i18next-browser-languagedetector';
...
const localizeInit = () => {
    i18next
        ...
        .init({
            ...
            supportedLngs: ['de', 'en', 'fr', 'ja', 'ko', 'zh-CN', 'moe'],
            fallbackLng: 'en',
            resources: {
                de: {
                    translation: {
                ...
                moe: {
                    translation: {
                        // File menu
                        'file': '(Innu-aimun) Fichier',
                        'file.new': '(Innu-aimun) Créer',
                        'file.open': '(Innu-aimun) Ouvrir',
                        'file.import': '(Innu-aimun) Importer...',
                        'file.load-all-data': '(Innu-aimun) Charger toutes les données ply',
                        'file.save': '(Innu-aimun) Enregistrer',
                        'file.save-as': '(Innu-aimun) Enregistrer sous...',
                        'file.publish': '(Innu-aimun) Publier...',
                        'file.export': '(Innu-aimun) Exporter',
                        'file.export.splat': '(Innu-aimun) Fichier splat',
                        'file.export.viewer': '(Innu-aimun) Application de visualisation...',
                    }
                },
            },
            interpolation: {
